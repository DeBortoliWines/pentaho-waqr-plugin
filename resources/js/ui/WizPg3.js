...
WizPg3 = function()
{
	...
	img.src = "resources/images/img_portrait.png";
	ctrl.addButton( Messages.getString("portraitBtnTxt"), "portrait", img );
	var img = document.createElement( "img" );
	img.src = "resources/images/img_landscape.png";
...
WizPg3.prototype.showPg = function()
{
	...
	this.step1Div.style.backgroundImage="url('resources/images/steps_active_slice.gif')";
    this.between_1_2.src = "resources/images/steps_middle_active.gif";
	this.step2Div.style.backgroundImage="url('resources/images/steps_active_slice.gif')";
    this.between_2_3.src = "resources/images/steps_middle_active.gif";
	this.step3Div.style.backgroundImage="url('resources/images/steps_active_slice.gif')";
    this.between_3_4.src = "resources/images/steps_middle_active.gif";
	this.step4Div.style.backgroundImage="url('resources/images/steps_active_slice.gif')";
    this.after_4.src = "resources/images/steps_middle_mixed.gif";
