...
WizPg0.prototype.showPg = function()
{
    ...
    this.between_1_2.src = "resources/images/steps_middle_mixed.gif";
	this.step2Div.style.backgroundImage="url('resources/images/steps_inactive_slice.gif')";
    this.between_2_3.src = "resources/images/steps_middle_inactive.gif";
	this.step3Div.style.backgroundImage="url('resources/images/steps_inactive_slice.gif')";
    this.between_3_4.src = "resources/images/steps_middle_inactive.gif";
	this.step4Div.style.backgroundImage="url('resources/images/steps_inactive_slice.gif')";
    this.after_4.src = "resources/images/steps_middle_inactive.gif";
